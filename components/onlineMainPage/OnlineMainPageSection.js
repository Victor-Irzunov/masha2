...
const OnlineMainPageSection = () => {
	...
	return (
		<section
			className='sd:px-20 xyy:px-5 pt-20 pb-28 mt-20'
		>
			<motion.div
				initial="hidden"
				whileInView="visible"
			>
				<motion.p
					...
					className='sd:text-8xl xyy:text-5xl text-white font-extrabold mb-0'
				>
					Консультация
				</motion.p>
				<br />
				<motion.p
					...
					className='sd:text-8xl xyy:text-5xl text-black pl-12 font-extrabold mb-0'
				>
					онлайн
				</motion.p>
			</motion.div>
			<div className='flex xyy:flex-col sd:flex-row justify-between items-center'>
