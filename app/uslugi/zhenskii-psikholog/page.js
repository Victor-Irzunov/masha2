...
export const metadata = {
	title : 'Женский психолог в Минске | Ирзунова Мария',
	description : 'Консультация женского психолога в Минске по женской психологии, отношениям, кризисам в жизни женщины. Запишитесь на консультацию уже сегодня!',
	alternates: {
		canonical: 'https://irzunova.by/uslugi/zhenskii-psikholog'
  },
  og: {
	title : 'Женский психолог в Минске | Ирзунова Мария',
	description : 'Консультация женского психолога в Минске по женской психологии, отношениям, кризисам в жизни женщины. Запишитесь на консультацию.',
    type: 'website',
    url: 'https://irzunova.by/uslugi/zhenskii-psikholog',
...
const Page = async () => {
	const { data } = await useDataService('zhenskii-psikholog');
		...
		<main className='pt-20 overflow-hidden'>
			<section>
				...
				>
					...
					<LinkArticleClient extraArticles='zhenskii-psikholog' />
				</div>
				<div
