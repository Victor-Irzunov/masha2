...
export const metadata = {
  ...
  og: {
	...
	description : 'Перинатальный психолог Ирзунова Мария в Минске поможет подготовиться к родам и материнству, справиться с послеродовой депрессией, тревогой и страхами. Психотерапия для беременных, рожениц и мам.',
    type: 'website',
    url: 'https://irzunova.by/uslugi/konsultatsiya-perinatalnogo-psikhologa',
...
const Page = async () => {
	const { data } = await useDataService('konsultatsiya-perinatalnogo-psikhologa');
		...
		<main className='pt-20 overflow-hidden'>
			<section>
				...
				>
					...
					<LinkArticleClient extraArticles='konsultatsiya-perinatalnogo-psikhologa' />
				</div>
				<div
