...
export const metadata = {
	title : 'Семейный психолог в Минске | Ирзунова Мария',
	...
	alternates: {
		canonical: 'https://irzunova.by/uslugi/semeinii-psikholog'
  },
  og: {
	title : 'Семейный психолог в Минске | Ирзунова Мария',
	description : 'Консультация семейного психолога в Минске по вопросам семейных и супружеских отношений, воспитания детей, конфликтов в семье.',
    type: 'website',
    url: 'https://irzunova.by/uslugi/semeinii-psikholog',
    image: '/images/main/main.webp',
  },
 }

const Page = async () => {
	const { data } = await useDataService('semeinii-psikholog');
		...
		<main className='pt-20 overflow-hidden'>
			<section>
				...
				>
					...
					<LinkArticleClient extraArticles='semeinii-psikholog' />
				</div>
				<div
