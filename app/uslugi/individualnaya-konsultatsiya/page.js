...
export const metadata = {
	...
	alternates: {
		canonical: 'https://irzunova.by/uslugi/individualnaya-konsultatsiya'
  },
  og: {
	title : 'Индивидуальная консультация психолога в Минске',
	description : 'Консультация перинатального психолога в Минске по вопросам бесплодия, планирования беременности, подготовки к родам и материнства.',
    type: 'website',
    url: 'https://irzunova.by/uslugi/individualnaya-konsultatsiya',
...
const Page = async () => {
	const { data } = await useDataService('individualnaya-konsultatsiya');
		...
		<main className='pt-20 overflow-hidden'>
			<section>
				...
				>
					...
					<LinkArticleClient extraArticles='individualnaya-konsultatsiya' />
				</div>
				<div
