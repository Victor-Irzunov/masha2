...
export const metadata = {
	title : 'Лечение депрессии в Минске | Психолог Ирзунова Мария',
	...
	alternates: {
		canonical: 'https://irzunova.by/uslugi/lechenie-depressii'
  },
  og: {
	title : 'Лечение депрессии в Минске | Психолог Ирзунова Мария',
	description : 'Консультация психолога в Минске по вопросам диагностики и лечения депрессии, тревожных расстройств, кризисных состояний.',
    type: 'website',
    url: 'https://irzunova.by/uslugi/lechenie-depressii',
...
const Page = async () => {
	const { data } = await useDataService('lechenie-depressii');
		...
		<main className='pt-20 overflow-hidden'>
			<section>
				...
				>
					...
					<LinkArticleClient extraArticles='lechenie-depressii' />
				</div>
				<div
