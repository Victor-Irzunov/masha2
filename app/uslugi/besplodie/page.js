...
export const metadata = {
	...
	alternates: {
		canonical: 'https://irzunova.by/uslugi/besplodie'
	},
	og: {
		title: 'Перинатальный психолог в Минске',
		description: 'Консультация перинатального психолога в Минске по вопросам бесплодия, планирования беременности, подготовки к родам и материнства.',
		type: 'website',
		url: 'https://irzunova.by/uslugi/besplodie',
...
const Page = async () => {
	const { data, extraArticles } = await useDataService('besplodie');
		...
		<main className='pt-20 overflow-hidden'>
			<section>
				...
				>
					...
					>
						<p className='text-xl text-[#191c1d] uppercase mb-8 font-semibold'>
							Области моей работы
						</p>
					...
					<LinkArticleClient extraArticles='besplodie' />
				</div>
				<div
				...
				<section
					...
					>
						...
						<BtnCompZapis conclusion price={data.price} />
					</div>
				</section>
			</section>
