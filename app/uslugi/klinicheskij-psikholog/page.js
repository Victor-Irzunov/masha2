...
export const metadata = {
	title : 'Клинический психолог в Минске | Ирзунова Мария',
	...
	alternates: {
		canonical: 'https://irzunova.by/uslugi/klinicheskij-psikholog'
  },
  og: {
	title : 'Клинический психолог в Минске | Ирзунова Мария',
	description : 'Консультация клинического психолога в Минске по различным психологическим проблемам, расстройствам, методам психотерапии.',
    type: 'website',
    url: 'https://irzunova.by/uslugi/klinicheskij-psikholog',
...
const Page = async () => {
	const { data } = await useDataService('klinicheskij-psikholog');
		...
		<main className='pt-20 overflow-hidden'>
			<section>
				...
				>
					...
					<LinkArticleClient extraArticles='klinicheskij-psikholog' />
				</div>
				<div
