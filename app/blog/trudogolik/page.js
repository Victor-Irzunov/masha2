...
export const metadata = {
	...
	alternates: {
		canonical: 'https://irzunova.by/blog/trudogolik'
	},
	og: {
		title: 'Трудоголик | Статья психолога Ирзуновой Марии',
		...
		type: 'website',
		url: 'https://irzunova.by/blog/trudogolik',
		image: '/articles/3.webp',
	},
}


const ArticleUniversalPage = () => {
	const data = dataArticles.find(article => article.link === 'trudogolik');
